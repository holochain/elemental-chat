...
module.exports = async (orchestrator) => {
  ...
  orchestrator.registerScenario('unique joining codes', async (s, t) => {
    ...
    let [alice_chat_happ, bob_chat_happ, carol_chat_happ, daniel_chat_happ] = await installAgents(conductor,  ["alice", "bob", "carol", "daniel" ], 0, [MEM_PROOF_READ_ONLY,  MEM_PROOF1, MEM_PROOF2, MEM_PROOF3], "uhCAkRHEsXSAebzKJtPsLY1XcNePAFIieFBtz2ATanlokxnSC1Kkz")
