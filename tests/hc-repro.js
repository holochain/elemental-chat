...
const network = {
  ...
  tuning_params: {
    ...
    default_rpc_multi_remote_request_grace_ms: 100, // Default was 10
...
orchestrator.registerScenario('two chatters, two conductors', async scenario => {
  ...
  await awaitIntegration([bobboChat, carolChat], [bobboChat, carolChat])
